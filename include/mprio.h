 ...
 */
PrioConfig
PrioConfig_newTest(int n_fields);
 ...
 */
SECStatus
PrioPRGSeed_randomize(PrioPRGSeed* seed);
...
void
PrioPacketVerify1_clear(PrioPacketVerify1 p1);
